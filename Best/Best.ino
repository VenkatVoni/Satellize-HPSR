...
char temp , x;
String bufferM ;
unsigned long Read_tme , Send_tme, now = 0 ;
Quaternion q;           //
...
void loop() {
  ...
  if ( temp == x  ) {                                                                        //to check if the read is a quetion mark
    ...
    if (bufferM == ""){
      com.print('!'); com.write((unsigned char)6); com.print("NoData");
    }
